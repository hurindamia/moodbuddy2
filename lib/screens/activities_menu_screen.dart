                ...
                child: Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      _activityBox(context, "Breathing", "4-7-8 Technique", Icons.air, Colors.white, BreathingScreen()),
                      const SizedBox(height: 20),
                      _activityBox(context, "Meditate", "Relaxation Timer", Icons.self_improvement, Colors.white, MeditationScreen()),
                      const SizedBox(height: 20),
                      _activityBox(context, "Feeling Wheel", "Emotion Explorer", Icons.color_lens, Colors.white, FeelingWheelScreen()),
                    ],
                  ),
                ),
              ),
